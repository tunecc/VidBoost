...
function selectMainTrack(events: TimedTextEvent[]): number | null {
...
function mergeFamilies(events: TimedTextEvent[]): SubtitleFragment[] {
...
export function parseStylizedKaraokeSubtitles(events: TimedTextEvent[]): SubtitleFragment[] {
