...
const strings = {
    en: {
        ...
        yt_member_mode_all: "Block all channels",
        yt_member_mode_blocklist: "Block specific channels",
        yt_member_mode_allowlist: "Allow specific channels",
    ...
    zh: {
        ...
        yt_member_mode_all: "屏蔽所有频道",
        yt_member_mode_blocklist: "仅屏蔽指定频道",
        yt_member_mode_allowlist: "仅允许指定频道",
